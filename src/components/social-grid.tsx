...
export function SocialGrid() {
  return (
    <div className="space-y-px">
      ...
      {/* StarDev Badge */}
      <a
        href="https://stardev.io/developers/buoysophit"
        target="_blank"
        rel="noopener noreferrer"
        className="group flex items-center gap-4 mt-3 border border-border rounded-lg bg-background p-4 hover:bg-accent/50 transition-colors overflow-hidden"
      >
        
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium leading-none">StarDev</p>
          <p className="text-xs text-muted-foreground mt-0.5">Language stats</p>
        </div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
